...
function ImagesTab() {
  return (
    <div className="Images-container">
      <Header
        title="Images"
        subtitle="These images will populate the Single Product Review image carousel and the Matrix product image."
      />
      ...
      <div className="Edit-images">
        <div>
          <p className="Drag-and-drop-text">
            Drag and drop to reorder. The image in the first position will <br /> always be the
            cover image for both the SPR and Matrix.
          </p>
